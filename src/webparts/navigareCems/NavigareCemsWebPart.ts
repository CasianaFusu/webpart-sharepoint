...
import NavigareCems from './components/NavigareCems';
import { INavigareCemsProps } from './components/INavigareCemsProps';
...
export default class NavigareCemsWebPart extends BaseClientSideWebPart<INavigareCemsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<INavigareCemsProps> = React.createElement(
      NavigareCems,
      {
